...
class RegisterTokenViewTests(TestCase):
    ...
    def test_authorized(self):
        ...
        response = self.client.get(reverse('frontend:view_hunt', kwargs=server_data))
    ...
    def test_not_logged_in(self):
        ...
        self.client.logout()
        response = self.client.get(reverse('frontend:view_hunt', kwargs=server_data))
        self.assertRedirects(response, reverse('login') + '?next=' + reverse('frontend:view_hunt', kwargs=server_data))
